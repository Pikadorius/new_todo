        ...
        <div className={s.container}>
            <div className={s.wrapper}>
                <div className={s.title}>
                    ...
                    <h3>{t('greetings.welcome')} <a  rel={'noreferrer'} target={'_blank'} className={s.link} href={'https://github.com/Pikadorius/new_todo'} title={t('greetings.code') || ''}>Todolist App</a></h3>
                </div>
